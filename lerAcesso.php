...
<div class="container">
  ...
  <a class="btn btn-success text-light btn-inline btn-lg mb-2 p-1"  name = "button" href="adicionarAcesso.php">Inserir</a>
  ...
  <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
    ...
    <tr>
      ...
      <td>
        <a href="editarAcesso.php?codigo=<?php echo $dado['id']; ?>">Editar</a>
        <a href="excluirAcesso.php?codigo=<?php echo $dado['id']; ?>">Excluir</a>
